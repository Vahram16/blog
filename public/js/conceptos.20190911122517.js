...
r=function(){dpi=window.devicePixelRatio;$('.js5').attr('src', (dpi>1) ? 'images/10-pasos-01-1882.png' : 'images/10-pasos-01-941.png');
...
$('.js4').attr('src', (dpi>1) ? 'images/pbl-learning2-01-590.png' : 'images/pbl-learning2-01-295.png');};
